...
//        SimpleScenarioState<String> state1 = new SimpleScenarioState<>("state1");
//        SimpleScenarioState<String> state2Null = new SimpleScenarioState<>("state2");
//        SimpleScenarioState<String> state2 = new SimpleScenarioState<>("state2", mappings, new HashMap<>());
//        SimpleScenarioState<String> state3 = new SimpleScenarioState<>("state3", mappings, new HashMap<>());
//
...
//
//        assertThat(((SimpleScenarioState<String>) result.get(state1).get(0).getSource()).getActions()).isNull();
//        assertThat(((SimpleScenarioState<String>) result.get(state1).get(0).getTarget()).getActions()).isNotNull();
//
//        assertThat(((SimpleScenarioState<String>) result.get(state2Null).get(0).getSource()).getActions()).isNull();
//        assertThat(((SimpleScenarioState<String>) result.get(state2Null).get(0).getTarget()).getActions()).isNotNull();
//    }
//
//    @Test
...
//
//        List<Transition<String>> transitions1 = result.get(new SimpleScenarioState<>("state1"));
//        List<Transition<String>> transitions2 = result.get(new SimpleScenarioState<>("state2"));
//
//        assertThat(transitions1).hasSize(1);
//        assertThat(transitions1.get(0).getTarget()).isEqualTo(new SimpleScenarioState<>("state3", mappings1, new HashMap<>()));
//
//        assertThat(transitions2).hasSize(1);
//        assertThat(transitions2.get(0).getTarget()).isEqualTo(new SimpleScenarioState<>("state3", mappings2, new HashMap<>()));
//    }
//}