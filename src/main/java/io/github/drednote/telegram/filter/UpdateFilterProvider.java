...
public interface UpdateFilterProvider {
  ...
  /**
   * Retrieves a list of conclusive post-update filters to be applied after processing the post-update filters.
   *
   * @param request The incoming Telegram update request. Must not be null
   * @return A list of conclusive post-update filters
   */
  List<ConclusivePostUpdateFilter> getConclusivePostFilters(@NonNull UpdateRequest request);
}
