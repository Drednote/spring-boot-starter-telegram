 ...
 * permission information and using the role assignment configuration from the {@link PermissionProperties}. If no roles
 * are assigned, it assigns the default role specified in the properties.
 *
...
public class RoleFilter implements PriorityPreUpdateFilter {
    ...
    /**
     * Constructs a RoleFilter with the specified {@link PermissionRepositoryAdapter} and {@link PermissionProperties}.
     *
     ...
     * @throws IllegalArgumentException if either permissionRepositoryAdapter or permissionProperties is null
     */
    public RoleFilter(
        @Nullable PermissionRepositoryAdapter permissionRepositoryAdapter,
     ...
     * permission information and using the role assignment configuration from the {@link PermissionProperties}. If no
     * roles are assigned, it assigns the default role specified in the properties.
     *
    ...
    public void preFilter(@NonNull UpdateRequest request) {
        ...
        if (user != null) {
            ...
            if (permissionRepositoryAdapter != null) {
