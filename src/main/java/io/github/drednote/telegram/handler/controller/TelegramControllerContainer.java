 ...
 * {@link TelegramRequestMapping} instances and corresponding {@link HandlerMethod} instances.
 * <p>
...
public class TelegramControllerContainer implements HandlerMethodPopular, ControllerRegistrar {
  ...
  /**
   * Populates the provided {@link TelegramUpdateRequest} with the appropriate
   * {@link RequestHandler} based on the incoming update. It matches the update against the
   * registered {@link TelegramRequestMapping} instances and sets the appropriate handler for
   * further processing.
   * <p>
   ...
   * <p>
   * To match with {@code TelegramUpdateRequest} using
   * {@link TelegramRequestMapping#matches(TelegramUpdateRequest)} method
   *
