...
//        ScenarioState<S> state = scenario.getState();
//        StateContext<S> stateContext = convertToStateContext(state);
//        return new ScenarioContext.SimpleScenarioContext<>(scenario.getId(), stateContext);
//    }
//
//    private @NonNull StateContext<S> convertToStateContext(ScenarioState<S> state) {
