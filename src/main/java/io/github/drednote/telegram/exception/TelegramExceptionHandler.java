 ...
 * {@code TelegramAdvice} and methods of this class, should be marked with {@code
 * TelegramExceptionHandler}
 *
 * <p>This annotation is used to identify methods that serve as exception handlers within a
 * Telegram
 * context. It allows specifying the types of exceptions that the annotated method is capable of
 * handling.
 *
