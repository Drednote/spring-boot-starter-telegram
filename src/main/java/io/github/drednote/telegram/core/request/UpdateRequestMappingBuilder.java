...
/**
 * The {@code UpdateRequestMappingBuilder} class is responsible for building Telegram request mappings based on provided
 * metadata. It allows constructing mappings with various combinations of patterns, request types, and message types.
 * <p>
 * It accepts a {@link TelegramRequestMappingMetaData} or {@link TelegramRequest} as input and generates multiple
 * {@link UpdateRequestMapping} instances based on the provided data. The generated mappings can then be processed using
 * a consumer.
 *
...
public class UpdateRequestMappingBuilder {
    ...
    /**
     * Constructs a {@code UpdateRequestMappingBuilder} using metadata from a {@link TelegramRequest}.
     *
     ...
     * {@link io.github.drednote.telegram.core.request.TelegramRequest}.
     *
     * @param requestMapping The Telegram request mapping annotation, not null
     */
    public UpdateRequestMappingBuilder(io.github.drednote.telegram.core.request.TelegramRequest requestMapping) {
        this(new TelegramRequestMappingMetaData(requestMapping));
    }
    ...
    /**
     * The {@code TelegramRequestMappingMetaData} class represents the metadata extracted from a {@link TelegramRequest}
     * annotation.
     *
     * @author Ivan Galushko
     */
    ...
    public static class TelegramRequestMappingMetaData {
        ...
        /**
         * Constructs a {@code TelegramRequestMappingMetaData} using a {@link TelegramRequest} annotation.
         *
         * @param requestMapping The Telegram request mapping annotation, not null
         */
        ...
        /**
         * Constructs a {@code TelegramRequestMappingMetaData} using a
         * {@link io.github.drednote.telegram.core.request.TelegramRequest} annotation.
         *
         * @param requestMapping The Telegram request mapping annotation, not null
         */
        public TelegramRequestMappingMetaData(io.github.drednote.telegram.core.request.TelegramRequest requestMapping) {
            Assert.required(requestMapping, "TelegramRequest");
